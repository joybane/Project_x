...
func fetchNSEBulkDeals() (int, error) {
	return fetchNSEDealsRange("bulk_deals", "c:/Workdesk/project_x/nse/bulk_deals", true)
}

func fetchNSEBlockDeals() (int, error) {
	return fetchNSEDealsRange("block_deals", "c:/Workdesk/project_x/nse/block_deals", true)
}

func fetchNSEShortSelling() (int, error) {
	return fetchNSEDealsRange("short_selling", "c:/Workdesk/project_x/nse/short_selling", false)
}
