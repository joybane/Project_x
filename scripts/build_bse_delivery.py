"""BSE delivery table, sourced from c:/Workdesk/raw/bse/delivery (SCBSEALL*.zip -> pipe-delimited TXT).
...
SRC = "c:/Workdesk/raw/bse/delivery"
DST = "c:/Workdesk/project_x/bse/delivery"
